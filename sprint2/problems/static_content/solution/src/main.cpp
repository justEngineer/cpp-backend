...
int main(int argc, const char* argv[]) {
    ...
    try {
        ...
        //     "/home/alex/cpp-backend/backend-repo/sprint2/problems/static_content/solution/data/config.json");
        // Путь к папке со статическими файлами
        fs::path static_folder_path{std::string(argv[2])};
        // fs::path static_folder_path{
        //     "/home/alex/cpp-backend/backend-repo/sprint2/problems/static_content/solution/static"};
        ...
        http_handler::RequestHandler handler{game, static_folder_path};
