...
inline StringResponse MakeStringResponse(http::status status, std::string_view body, StringRequest request,
...
inline HttpResponse MakeFileResponse(http::status status, http::file_body::value_type& body, size_t size,
